...
CREATE TABLE `adres` (
  ...
  `nr_domu` decimal(3,0) NOT NULL,
  `nr_mieszkania` decimal(3,0) DEFAULT NULL,
...
INSERT INTO `adres` VALUES (1,'os. Tysiaclecia',12,12,'62-300','Poznan'),(2,'Brzozowa',12,0,'61-345','Krakow'),(3,'Karwowskiego',12,15,'32-000','Warszawa'),(4,'ww',12,12,'62-00','Warszawa');
