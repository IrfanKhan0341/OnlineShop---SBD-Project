...
<div id="header">
    <div class="container">
        <div class="flag">
          <a href="ProductControllerLog?theLocale=en_GB"> <img alt="English" src="img/en_GB_flag.png"/> </a>  
        </div>
        <div class="flag">
            <a href="ProductControllerLog?theLocale=pl_PL"> <img alt="Polski" src="img/pl_PL_flag.png"/> </a>
        </div>
...
<div id="content">
    <div class="container">
        ...
        <div class="strona">
            <ul>
                <li><a href="ProductListBeginLog"><fmt:message key="label.back"/></a></li>
                <li>
                    <ol>
                        <li> 1 </li>
                        <li> ... </li>
                ...
                <li><a href="ProductControllerLog"><fmt:message key="label.next"/></a></li>
            </ul>
        </div> 
