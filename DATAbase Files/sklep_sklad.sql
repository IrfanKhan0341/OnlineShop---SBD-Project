...
CREATE TABLE `sklad` (
  ...
  `ilosc` decimal(4,0) NOT NULL,
  `bialko` decimal(3,0) DEFAULT NULL,
  `tluszcze` decimal(3,0) DEFAULT NULL,
  `weglowodany` decimal(3,0) DEFAULT NULL,
...
INSERT INTO `sklad` VALUES (1,1000,10,3,20),(2,500,25,30,15),(3,1000,1,0,3),(4,500,22,22,12),(5,500,2,2,30),(6,1000,3,1,20);
