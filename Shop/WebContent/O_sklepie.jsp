...
<div id="header">
    <div class="container">
        <div class="flag">
          <a href="O_sklepie.jsp?theLocale=en_GB"> <img alt="English" src="img/en_GB_flag.png"/> </a>  
        </div>
        <div class="flag">
            <a href="O_sklepie.jsp?theLocale=pl_PL"> <img alt="Polski" src="img/pl_PL_flag.png"/> </a>
        </div>
